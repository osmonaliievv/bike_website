				...
				<div className="details__top">
					...
					<div className="details__block2 ">
						...
						<div className="details__descr">
							...
							Одна из самых легких рам среди гоночных хардтейлов для кросс-канри.
						</div>
				...
				<div className="details__block3">
					<div className="details__title">
						...
						<p className="details__name-descr">
							Профессиональный гоночный хардтейл для кросс-кантри уровня Чемпионата и Кубка Мира.
							Одна из самых лёгких рам среди гоночных хардтейлов для кросс-кантри. Scott Scale
							700 RC — это рама из композитного волокна HMX, гоночная трансмиссия Sram XX1/X01 1×11,
